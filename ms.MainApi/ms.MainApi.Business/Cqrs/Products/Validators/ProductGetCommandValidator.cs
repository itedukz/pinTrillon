...
public class ProductGetCommandValidator : AbstractValidator<ProductGetCommand>
{
    private readonly IMessagesRepository _messagesRepository;
    private readonly IProductDal _entityDal;

    public ProductGetCommandValidator(IMessagesRepository messagesRepository, IProductDal entityDal)
    {
