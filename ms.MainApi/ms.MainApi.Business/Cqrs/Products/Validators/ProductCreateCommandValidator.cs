...
public class ProductCreateCommandValidator : AbstractValidator<ProductCreateCommand>
{
    ...
    public ProductCreateCommandValidator(IMessagesRepository messagesRepository, IProductArticleDal productArticleDal,
        IBrandDal brandDal, IMaterialDal materialDal, ICatalogDal catalogDal)
    {
