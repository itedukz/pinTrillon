...
public class ProductArticleDeleteCommandValidator : AbstractValidator<ProductArticleDeleteCommand>
{
    private readonly IMessagesRepository _messagesRepository;
    private readonly IProductArticleDal _entityDal;

    public ProductArticleDeleteCommandValidator(IMessagesRepository messagesRepository, IProductArticleDal entityDal)
    {
