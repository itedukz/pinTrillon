...
public class MaterialDeleteCommandValidator : AbstractValidator<MaterialDeleteCommand>
{
    private readonly IMessagesRepository _messagesRepository;
    private readonly IMaterialDal _entityDal;

    public MaterialDeleteCommandValidator(IMessagesRepository messagesRepository,
