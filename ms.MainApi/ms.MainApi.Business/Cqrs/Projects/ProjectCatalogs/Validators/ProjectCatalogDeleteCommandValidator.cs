...
public class ProjectCatalogDeleteCommandValidator : AbstractValidator<ProjectCatalogDeleteCommand>
{
    private readonly IMessagesRepository _messagesRepository;
    private readonly IProjectCatalogDal _entityDal;

    public ProjectCatalogDeleteCommandValidator(IMessagesRepository messagesRepository,
