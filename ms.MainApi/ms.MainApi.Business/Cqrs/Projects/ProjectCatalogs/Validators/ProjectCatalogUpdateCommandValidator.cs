...
public class ProjectCatalogUpdateCommandValidator : AbstractValidator<ProjectCatalogUpdateCommand>
{
    private readonly IMessagesRepository _messagesRepository;
    private readonly IProjectCatalogDal _entityDal;

    public ProjectCatalogUpdateCommandValidator(IMessagesRepository messagesRepository,
