...
public class ProjectGetCommandValidator : AbstractValidator<ProjectGetCommand>
{
    private readonly IMessagesRepository _messagesRepository;
    private readonly IProjectDal _entityDal;

    public ProjectGetCommandValidator(IMessagesRepository messagesRepository, IProjectDal entityDal)
    {
