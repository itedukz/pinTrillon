...
public class BasketAddProjectCommandValidator : AbstractValidator<BasketAddProjectCommand>
{
    private readonly IMessagesRepository _messagesRepository;
    private readonly IProjectDal _entityDal;

    public BasketAddProjectCommandValidator(IMessagesRepository messagesRepository, IProjectDal entityDal)
    {
