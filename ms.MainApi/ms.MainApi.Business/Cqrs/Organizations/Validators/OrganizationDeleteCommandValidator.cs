...
public class OrganizationDeleteCommandValidator : AbstractValidator<OrganizationDeleteCommand>
{
    private readonly IMessagesRepository _messagesRepository;
    private readonly IOrganizationDal _entityDal;

    public OrganizationDeleteCommandValidator(IMessagesRepository messagesRepository,
